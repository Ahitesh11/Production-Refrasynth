...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'temp_h1', label: 'Temp H1', type: 'number' },
      { name: 'temp_h2', label: 'Temp H2', type: 'number' },
      { name: 'temp_h3', label: 'Temp H3', type: 'number' },
      { name: 'temp_h4', label: 'Temp H4', type: 'number' },
      { name: 'temp_h5', label: 'Temp H5', type: 'number' },
      { name: 'temp_h6', label: 'Temp H6', type: 'number' },
      { name: 'temp_h7', label: 'Temp H7', type: 'number' },
      { name: 'temp_h8', label: 'Temp H8', type: 'number' },
