...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'temp_h1', label: 'Temperature H1', type: 'number' },
      { name: 'temp_h2', label: 'Temperature H2', type: 'number' },
      { name: 'temp_h3', label: 'Temperature H3', type: 'number' },
      { name: 'temp_h4', label: 'Temperature H4', type: 'number' },
      { name: 'temp_h5', label: 'Temperature H5', type: 'number' },
      { name: 'temp_h6', label: 'Temperature H6', type: 'number' },
      { name: 'temp_h7', label: 'Temperature H7', type: 'number' },
      { name: 'temp_h8', label: 'Temperature H8', type: 'number' },
      { name: 'moisture_h1', label: 'Moisture H1', type: 'number' },
      { name: 'moisture_h2', label: 'Moisture H2', type: 'number' },
      { name: 'moisture_h3', label: 'Moisture H3', type: 'number' },
      { name: 'moisture_h4', label: 'Moisture H4', type: 'number' },
      { name: 'moisture_h5', label: 'Moisture H5', type: 'number' },
      { name: 'moisture_h6', label: 'Moisture H6', type: 'number' },
      { name: 'moisture_h7', label: 'Moisture H7', type: 'number' },
      { name: 'moisture_h8', label: 'Moisture H8', type: 'number' },
    ]
  },
  {
    id: 'balling_disc',
  ...
  {
    id: 'campaign_opening',
    name: 'Campaign Opening',
    category: 'Stock',
    fields: [
      { name: 'campaign_no', label: 'Campaign No.', type: 'select', options: [] },
      { name: 'opening_date', label: 'Date of Opening of kiln', type: 'date' },
      { name: 'start_time', label: 'Start Time', type: 'time' },
      { name: 'calc_date', label: 'Date Of Calculation', type: 'date' },
      { name: 'incharge_name', label: 'Incharge Name', type: 'select', options: [] },
      { name: 'sb3_hopper3', label: 'SB3 Hopper3', type: 'number' },
      { name: 'sb3_hopper4', label: 'SB3 Hopper4', type: 'number' },
      { name: 'sb3_hopper5', label: 'SB3 Hopper5', type: 'number' },
      { name: 'ppt_qty', label: 'PPT Qty', type: 'number' },
      { name: 'sb4_qty', label: 'SB4 Qty', type: 'number' },
      { name: 'ball_mill', label: 'Ball Mill', type: 'number' },
      { name: 'bc_10', label: 'BC 10', type: 'number' },
      { name: 'bc_11', label: 'BC 11', type: 'number' },
      { name: 'bc_12', label: 'BC 12', type: 'number' },
      { name: 'bc_13', label: 'BC 13', type: 'number' },
      { name: 'mixture_balling_dics', label: 'Mixture (Balling Dics)', type: 'number' },
      { name: 'balling_disc_4nos', label: 'Balling Disc X 4Nos.', type: 'number' },
      { name: 'tg_beg', label: 'Tg Beg', type: 'number' },
      { name: 'kiln', label: 'Kiln', type: 'number' },
      { name: 'cooler', label: 'Cooler', type: 'number' },
      { name: 'opening_reason', label: 'Remarks/Reason', type: 'text' },
    ]
  },
  {
    id: 'campaign_closing',
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'note', label: 'Note', type: 'text' },
      { name: 'rm1_pct', label: 'Rm 1 %', type: 'number', readonly: true },
      { name: 'rm2_pct', label: 'Rm 2 %', type: 'number', readonly: true },
      { name: 'rm3_pct', label: 'Rm 3 %', type: 'number', readonly: true },
      { name: 'rm1_min', label: 'Rm 1 Min', type: 'number', readonly: true },
      { name: 'rm1_max', label: 'Rm 1 Max', type: 'number', readonly: true },
      { name: 'rm2_min', label: 'Rm 2 Min', type: 'number', readonly: true },
      { name: 'rm2_max', label: 'Rm 2 Max', type: 'number', readonly: true },
      { name: 'rm3_min', label: 'Rm 3 Min', type: 'number', readonly: true },
      { name: 'rm3_max', label: 'Rm 3 Max', type: 'number', readonly: true },
    ]
  },
  {
    id: 'spillage',
    ...
    fields: [
      ...
      { name: 'incharge_name', label: 'Incharge Name', type: 'select', options: [] },
      { name: 'product_name', label: 'Product Name', type: 'select', options: [] },
      { name: 'hot_screen_qty', label: 'Hot Screen Qty', type: 'number' },
      { name: 'multi_cyclone_qty', label: 'Multi Cyclone Qty', type: 'number' },
      { name: 'house_keeping', label: 'House Keeping', type: 'number' },
      { name: 'road_side', label: 'Road Side', type: 'number' }
    ]
  },
  {
    id: 'production_stop',
    name: 'Why Production Stop',
    category: 'Process',
    fields: [
      { name: 'campaign_no', label: 'Campaign No.', type: 'select', options: [] },
      { name: 'date', label: 'Date', type: 'date' },
      { name: 'shift', label: 'Shift', type: 'select', options: ['Shift A', 'Shift B', 'Shift C'] },
      { name: 'incharge_name', label: 'Incharge Name', type: 'select', options: [] },
      { name: 'time_stop', label: 'Time Stop', type: 'time' },
      { name: 'department', label: 'Department', type: 'select', options: ['Electrical ⚡', 'Mechanical ⚙️', 'Process 🔬', 'Application'] },
      { name: 'problem_description', label: 'Problem Description', type: 'text' },
      { name: 'machine_name', label: 'Machine Name', type: 'text' },
      { name: 'reported_by', label: 'Reported By', type: 'text' },
      { name: 'planned', label: 'Planned', type: 'datetime-local' },
      { name: 'actual', label: 'Actual', type: 'datetime-local' },
      { name: 'delay', label: 'Delay', type: 'text' },
